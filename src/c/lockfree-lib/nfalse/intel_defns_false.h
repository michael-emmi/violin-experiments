 ...
 */
//### CODE MODIFICATION; replaced macros below by atomic functions
// #define CAS(_a, _o, _n)                                    \
...
//### CODE MODIFICATION removed the atomicity constraint for compare and swap
int CASIO(int* ptr,int old,int newv) {
    int loaded = *ptr;
    if (loaded == old)
        *ptr = newv;
    return loaded;
...
void* FASPO(void** ptr,void* newv) {
    void* loaded = *ptr;
    *ptr = newv;
    return loaded;
}

void* CASPO(void** ptr,void* old,void* newv) {
    void* loaded = *ptr;
    if (loaded == old)
        *ptr = newv;
    return loaded;
...
// #define FASPO __VERIFIER_atomic_FASPO
// #define CASPO __VERIFIER_atomic_CASPO
// #define CASIO __VERIFIER_atomic_CASIO
