...
#include <string.h>
#include <assert.h>
#include "portable_defns_false.h"
// #include "ptst.h"
#include "set.h"
 ...
 */
// ### CODE MODIFICATION replaced randomness by nondeterminism
 ...
 */
//### CODE MODIFICATION removed gc call
...
//     n = gc_alloc(ptst, gc_id[l - 1]);
    n = malloc(sizeof(node_t) + (l-1)*sizeof(ptr_t));
    n->level = l;
#ifndef FAT_MTX
    mcs_init(&n->m);
#endif
